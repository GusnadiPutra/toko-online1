...
$( "#slider-range" ).slider({
  ...
  $('input[name="first_price"]').val( "Rp. " + ui.values[0]);
  $('input[name="last_price"]').val( "Rp. " + ui.values[1]);
},
});
$( "#amount" ).val( "Rp. " + $( "#slider-range" ).slider( "values", 0 ) +
" - "+"Rp. " + $( "#slider-range" ).slider( "values", 1 ) );
$('input[name="first_price"]').val( "Rp. " + $( "#slider-range" ).slider( "values", 0 ));
$('input[name="last_price"]').val( "Rp. " + $( "#slider-range" ).slider( "values", 1 ));
/*--------------------------
 scrollUp
---------------------------- */	
	$.scrollUp({
