...
while ($rowjenis = $resultjenis->fetch_assoc()) {
    ...
    if(isset($_GET['idfilter'])){
        $getfilter = "&idfilter=".$_GET['idfilter'];
        if ($_GET['idfilter']=="0"){
            $carifilter = " ORDER BY a.nama_barang ASC";
        }elseif ($_GET['idfilter']=="1"){
            $carifilter = " ORDER BY a.nama_barang DESC";
        }elseif ($_GET['idfilter']=="2"){
            $carifilter = " ORDER BY harga_barang DESC";
        }elseif ($_GET['idfilter']=="3"){
            $carifilter = " ORDER BY harga_barang ASC";
        }
        $setfilter = $_GET['idfilter'];
    }else{
        $getfilter = "";
        $carifilter = "";
        $setfilter = "0";
    ...
    if(isset($_GET['idfilter1'])){
        $getfilter1 = "&idfilter1=".$_GET['idfilter1'];
        if ($_GET['idfilter1']=="0"){
            $carifilter = " ORDER BY a.nama_barang ASC";
        }elseif ($_GET['idfilter1']=="1"){
            $carifilter = " ORDER BY a.nama_barang DESC";
        }elseif ($_GET['idfilter1']=="2"){
            $carifilter = " ORDER BY harga_barang DESC";
        }elseif ($_GET['idfilter1']=="3"){
            $carifilter = " ORDER BY harga_barang ASC";
        }
        $setfilter = $_GET['idfilter'];
    }else{
    ...
    $gabungget = "?hal=home".$getfilter."".$getpencarian;
    $gabungcari = $carikat;
    ?>
                        </div>
                        <br>
                                            ...
                                            <div class="price_filter">
                                                ...
                                                <br><div>
                                                        ...
                                                        <select class="form-control" id="filter1" name="filter1">
                                                            ...
                                                            while ($rowjenis = $resultjenis->fetch_assoc()) {
                                                                ?>
                                                                <option value="<?php echo $rowjenis['warna']; ?>"><?php echo $rowjenis['warna']; ?></option>
                                                                <?php
                                                            }
                                                            ?>
                                                        </select>
                                                ...
                                                <br><div>
                                                        <input type="submit" name="submit_range" value="Filter Product" class="btn btn-success btn-sm">
                                                    </div>
                                                </div>
                                            </div>							
                                        </div>
                                        ...
                                        <div role="tabpanel ">
                                            <div class="row">
                                                <div class="shop-tab">
                                                    ...
                                                    $qry = "SELECT * FROM tb_dataproduk INNER JOIN tb_kategori WHERE tb_dataproduk.id_kategori=tb_kategori.id_kategori AND tb_kategori.id_kategori='$idd' ORDER BY tb_dataproduk.id_kategori ASC";
                                        ...
                                        <div role="tabpanel " class="tab-pane active">
                                            <div class="row">
                                                <div class="shop-tab">
                                                    <!-- single-product start -->
                                                    <?php
                                                    $qry = "SELECT * FROM tb_dataproduk INNER JOIN tb_kategori WHERE tb_dataproduk.id_kategori=tb_kategori.id_kategori  ORDER BY tb_dataproduk.id_kategori ASC";
                                                    $resultjenis = $mysqli->query($qry);
                                                    $cek = mysqli_num_rows($resultjenis);
                                                        if($cek>0){
                                                            while ($row = $resultjenis->fetch_assoc()) {
