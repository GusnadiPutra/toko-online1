                                            ...
                                            <div class="price_filter">
                                                    ...
                                                    <div class="form-price-range-filter">
                                                            ...
                                                            <input type="" id="min" name="min_price"
                                                                value="0" class="form-control uang" placeholder="Rp.">
                                                                <h3 class="wg-title2" style=margin-top:25px>-</h3>
                                                    ...
                                                    <br>
                                                    <br><div>
                                                        <h3 class="wg-title2" style=margin-top:-10px >Choose Size</h3>
                                            ...
                                            <div class="row">
                                                <div class="shop-tab">
                                                    ...
                                                    <?php
                                                        ...
                                                        $qry = "SELECT * FROM tb_dataproduk INNER JOIN tb_kategori WHERE  ukuran='$setfilter' OR warna='$setfilter1' OR harga BETWEEN '$min' AND '$max' GROUP BY (id_produk) ORDER BY id_produk ASC";
                                                        $resultjenis = $mysqli->query($qry);
                                                        $cek = mysqli_num_rows($resultjenis);
