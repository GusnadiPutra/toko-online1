  ...
  <div class="">
    <div class="page-title">
      <div class="title_left">
        <h3>Laporan Not Received Order</h3>
      </div>
    </div>
  </div>
  ...
  $(document).ready(function(){
    $(".cek-submit").click(function(e){
      ...
      if(cdaritgl > csampetgl){
        ...
        $.ajax({
          url: '../cetak/laporanunreceived.php',
          ...
          if(cekdata == 0){
            ...
            window.open('../cetak/laporanunreceived.php?daritgl='+obj.daritgl+'&sampetgl='+obj.sampetgl+'&cekawal=0');
          }
        });
      }
